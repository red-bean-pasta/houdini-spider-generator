...
I usually use one line between main method and helper method, or between helper methods, and two new lines between two main methods. By "main method", I mean method that does a script level job, or orchestrating multiple helper methods. I believe you are familiar with what I mean.
