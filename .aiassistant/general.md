...
Put helper and modular methods after the parent method instead of before it. This is because users usually read from the top, therefore higher position means more importance. If two parent methods share the same child method, put it at the last of the script.
