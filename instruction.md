...
- Run `hython test_builder.py` after changes and retain the regenerated `test.hip` for manual inspection. No backing up.
...
- Keep names concise and descriptive; follow the existing `_verb_noun` SOP-builder naming style.
